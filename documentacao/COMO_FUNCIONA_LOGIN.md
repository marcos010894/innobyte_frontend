...
6. Sistema executa:
   ...
   ↓
7. Faz requisição:
   POST https://innobyte.fly.dev//auth/login-cliente
   Body: {
...
8. Sistema executa:
   ...
   ↓
9. Faz requisição:
   POST https://innobyte.fly.dev//auth/login
   Body: {
...
Cliente:
Request URL: https://innobyte.fly.dev//auth/login-cliente
Request Method: POST
Status Code: 200 OK

Master:
Request URL: https://innobyte.fly.dev//auth/login
Request Method: POST
Status Code: 200 OK
```
