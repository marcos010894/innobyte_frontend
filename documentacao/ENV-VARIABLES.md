...
```bash
flyctl secrets set VITE_API_URL=https://innobyte.fly.dev/api
```
...
ARG VITE_API_URL=https://innobyte.fly.dev/api
...
3. Gerar bundle com `VITE_API_URL=https://innobyte.fly.dev/api`
4. Servir via Nginx
...
// Deve mostrar: https://innobyte.fly.dev/api
```
